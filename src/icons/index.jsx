...
/**
 * Danger zone / warning triangle icon (filled).
 * @param {IconProps & {fill?: string}} props
 * @returns {JSX.Element}
 */
export function DangerZoneIcon({ size = 24, fill = 'currentColor', className, ...props }) {
  return (
    <svg
      width={size}
      height={size}
